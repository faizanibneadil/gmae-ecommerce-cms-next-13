  ...
  return (
    <ContextMenu>
      ...
      <ContextMenuContent className="w-40">
        <Link
          href={`/distribution/${distributionId}/inventory/${item.id}/images`}
        >
        ...
        <Link
          href={`/distribution/${distributionId}/inventory/${item.id}/companies`}
        >
          <ContextMenuItem>
            <PencilIcon className="w-4 h-4 mr-2" /> Companies
          </ContextMenuItem>
        </Link>
        <Link href={`/distribution/${distributionId}/inventory/${item.id}/seo`}>
          <ContextMenuItem>
            <PencilIcon className="w-4 h-4 mr-2" /> SEO
          </ContextMenuItem>
        </Link>
        <Link
          href={`/distribution/${distributionId}/inventory/${item.id}/attributes`}
        >
          <ContextMenuItem>
        ...
        <Link
          href={`/distribution/${distributionId}/inventory/${item.id}/variants`}
        >
          <ContextMenuItem>
