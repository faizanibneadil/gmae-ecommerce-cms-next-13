...
import { $initialShopCreateAction } from "@/mutations";
...
const CreateShopCard: React.FC<{}> = () => {
  ...
  const onSubmit = (values: any) => {
    toast.promise($initialShopCreateAction({ distributionId, ...values }), {
      success: (id) => {
        router.replace(`/distribution/${distributionId}/shops`);
        return "success";
      },
      error: (msg) => `${msg}`,
      loading: "Creating ...",
