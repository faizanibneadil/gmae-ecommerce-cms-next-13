...
const FindByIssueDate: React.FC<{}> = memo(() => {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          {/* {deliveryDate ? format(deliveryDate, "PPP") : <span>Issue Date</span>} */}
          ok...
...
FindByIssueDate.displayName = "FindByIssueDate";
export default FindByIssueDate;
